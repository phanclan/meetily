    ...
    let attrs = tauri_build::Attributes::new().plugin(
        ...
        tauri_build::InlinedPlugin::new()
            .commands(&[
                ...
                "save_recording_chat",
                "list_note_tasks",
                "save_meeting_notes_if_unchanged",
                "discard_recording_chat",
                "search_library_sources",
                "get_recent_library_sources",
                "search_saved_meetings",
                "list_note_folders",
                "create_note_folder",
                "rename_note_folder",
                "get_note_folder_members",
                "get_meeting_note_folders",
                "set_meeting_note_folder",
                "trash_meeting",
                "restore_trashed_meeting",
                "list_trashed_meetings",
                "delete_trashed_meeting",
                "get_previous_summary",
                "restore_previous_summary",
                "get_export_folder",
                "choose_export_folder",
                "export_meeting_markdown",
                "get_saved_search_match",
                "get_library_chat",
                "save_library_chat",
                "get_library_chat_settings",
                "save_library_chat_settings",
                "list_library_chats",
                "set_library_chat_archived",
