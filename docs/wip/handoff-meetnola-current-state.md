...
Active dev bundle: `/private/tmp/meetnola Dev.app`, build `20260908-2146-safe-quit`, with frontend hot reload on port 3118. The source-coverage fixes and updated standard template are installed and visually verified. Local Parakeet Compact and Ollama `qwen3.5:4b-mlx` remain selected; recording is stopped. The standalone tester remains unchanged.
